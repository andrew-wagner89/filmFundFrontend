                        ...
                        <Col>
                            <PanelGroup>
                                <Panel className="black" header={<PageHeader>About the Film Fund</PageHeader>}>
                                    <PageHeader><small>
                                        The Film Fund is an alternative to film industry funding platforms such as screenwriting, time-intensive grant applications, and crowdfunding campaigns found on websites such as Kickstarter, Indiegogo, or Seed & Spark. We want to level the funding field and take the skewed advantages out of independent film.
                                        <br/>
